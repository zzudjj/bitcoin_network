...
block = create_block(block_height=1, coinbase_str="Hello Bitcoin!", pre_block_hash=block_chain.get_best_block_hash(), mem_pool=mem_pool, tx_num=1, utxo_set=utxo_set, address=wallet1.get_address())
print(f"wallet1_balance: {wallet1.get_balance(utxo_set=utxo_set)}")
print(block.to_json())
